...
public class GameService {
    private static final String TOKEN = "Bearer pcde5ct7kruawef8cpc8ppyczgfcl6";
    ...
    private String buildGameURL(String url, String gameName, int limit) {
        if (gameName.equals("")) {
            // String.format(String format, arg)
    ...
    // search stream/video/clip for the parameter gameId and return a hashmap
    // key is the type, value is a list of result
